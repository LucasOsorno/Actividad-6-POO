...
public class UserWindow extends JFrame {
    ...
    public UserWindow() {
        ...
        buttonPanel.add(createButton("Create", new Color(88, 176, 203), e -> createUser()));  // Azul brillante
        buttonPanel.add(createButton("Read", new Color(28, 155, 183), e -> readUsers()));     // Azul medio
        buttonPanel.add(createButton("Update", new Color(10, 88, 120), e -> updateUser()));   // Azul oscuro
        buttonPanel.add(createButton("Delete", new Color(243, 128, 0), e -> deleteAllUsers())); // Naranja intenso
        buttonPanel.add(createButton("Clear", new Color(230, 75, 40), e -> clearFields()));   // Naranja fuerte
        buttonPanel.add(createButton("Search by ID", new Color(215, 232, 237), e -> searchUserByID())); // Celeste claro
